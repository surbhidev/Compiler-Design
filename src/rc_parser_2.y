...
int main(int argc, char **argv) {
    ...
    // fprintf(yacc_output, "except NameError:\n");
    // fprintf(yacc_output, "\tprint(\"Variable x is not defined\")\n");
    // fprintf(yacc_output, "except:");
    // fprintf(yacc_output, "\tprint(\"Something else went wrong\")");
