...
static const yytype_int16 yyrline[] =
{
     ...
     740,   776,   811,   867,   898,   928,   961,   992,   996,  1054,
    1061,  1070,  1100,  1134,  1143,  1149,  1155,  1160,  1165,  1173,
    1179,  1185,  1193,  1199,  1205,  1211,  1217,  1223,  1232,  1238,
    1245,  1253,  1260,  1268,  1282,  1288,  1293,  1300,  1308,  1314,
    1323,  1324,  1328,  1334,  1342,  1348,  1356,  1362,  1368,  1374,
    1380,  1387,  1395,  1396,  1406,  1412,  1421,  1430,  1431,  1432,
    1433,  1434,  1435,  1436,  1437,  1438,  1442,  1452,  1462,  1466,
    1471,  1479,  1483,  1487,  1492,  1500,  1505,  1510,  1511,  1512,
    1517,  1522,  1523,  1528,  1533,  1541,  1542,  1547,  1555,  1560,
    1565,  1573,  1574,  1578,  1579,  1580,  1581,  1582,  1583,  1587,
    1596,  1601,  1606,  1614,  1622,  1630,  1631,  1632,  1633,  1637,
    1648,  1658,  1668,  1677,  1684,  1693
};
#endif
...
#line 741 "../src/rc_parser.y"
                                                    { 
                                                                ...
                                                                fprintf(yacc_output,"%s.head(%s)\n", identifier, (yyvsp[-1].str));
                                                                                    char buffer[256]; 
                                                                                    snprintf(buffer, sizeof(buffer), "print(%s.head(%s))", identifier, (yyvsp[-1].str));
                                                                                    (yyval.str) = strdup(buffer);
...
#line 777 "../src/rc_parser.y"
                                                    { 
                                                                ...
                                                                char buffer[256]; 
                                                                                    snprintf(buffer, sizeof(buffer), "print(%s.tail(%s))", identifier, (yyvsp[-1].str));
                                                                                    (yyval.str) = strdup(buffer);
...
#line 1582 "../src/rc_parser.y"
                    {(yyval.str) = strdup(" != ");}
#line 3878 "y.tab.c"
    break;

  case 158: /* comparison_operators: DEQ_OPERATOR  */
#line 1583 "../src/rc_parser.y"
                    {(yyval.str) = strdup(" == ");}
#line 3884 "y.tab.c"
    break;
